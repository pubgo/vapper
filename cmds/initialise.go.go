...
func init() {
	...
	rootCmd.AddCommand(initDisCmd(&cobra.Command{
		Use:   "dis",
		Short: "dis",
		Run: func(cmd *cobra.Command, args []string) {
			...
			errors.Panic(CreateAssetsZip(storer, root, archives))

			// Creates the wasm_exec file (WASMGO ONLY)
			errors.Panic(Wasm(storer))

			fmt.Println("Waiting for storage operations...")
			errors.Panic(storer.Wait())
